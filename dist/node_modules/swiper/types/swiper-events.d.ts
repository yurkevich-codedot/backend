...
import { A11yEvents } from 'swiper/types/modules/a11y';
import { AutoplayEvents } from 'swiper/types/modules/autoplay';
import { ControllerEvents } from 'swiper/types/modules/controller';
import { CoverflowEffectEvents } from 'swiper/types/modules/effect-coverflow';
import { CubeEffectEvents } from 'swiper/types/modules/effect-cube';
import { FadeEffectEvents } from 'swiper/types/modules/effect-fade';
import { FlipEffectEvents } from 'swiper/types/modules/effect-flip';
import { CreativeEffectEvents } from 'swiper/types/modules/effect-creative';
import { CardsEffectEvents } from 'swiper/types/modules/effect-cards';
import { HashNavigationEvents } from 'swiper/types/modules/hash-navigation';
import { HistoryEvents } from 'swiper/types/modules/history';
import { KeyboardEvents } from 'swiper/types/modules/keyboard';
import { LazyEvents } from 'swiper/types/modules/lazy';
import { MousewheelEvents } from 'swiper/types/modules/mousewheel';
import { NavigationEvents } from 'swiper/types/modules/navigation';
import { PaginationEvents } from 'swiper/types/modules/pagination';
import { ParallaxEvents } from 'swiper/types/modules/parallax';
import { ScrollbarEvents } from 'swiper/types/modules/scrollbar';
import { ThumbsEvents } from 'swiper/types/modules/thumbs';
import { VirtualEvents } from 'swiper/types/modules/virtual';
import { ZoomEvents } from 'swiper/types/modules/zoom';
import { FreeModeEvents } from 'swiper/types/modules/free-mode';
