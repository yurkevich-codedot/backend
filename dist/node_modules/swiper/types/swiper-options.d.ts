import { A11yOptions } from 'swiper/types/modules/a11y';
import { AutoplayOptions } from 'swiper/types/modules/autoplay';
import { ControllerOptions } from 'swiper/types/modules/controller';
import { CoverflowEffectOptions } from 'swiper/types/modules/effect-coverflow';
import { CubeEffectOptions } from 'swiper/types/modules/effect-cube';
import { FadeEffectOptions } from 'swiper/types/modules/effect-fade';
import { FlipEffectOptions } from 'swiper/types/modules/effect-flip';
import { CreativeEffectOptions } from 'swiper/types/modules/effect-creative';
import { CardsEffectOptions } from 'swiper/types/modules/effect-cards';
import { HashNavigationOptions } from 'swiper/types/modules/hash-navigation';
import { HistoryOptions } from 'swiper/types/modules/history';
import { KeyboardOptions } from 'swiper/types/modules/keyboard';
import { LazyOptions } from 'swiper/types/modules/lazy';
import { MousewheelOptions } from 'swiper/types/modules/mousewheel';
import { NavigationOptions } from 'swiper/types/modules/navigation';
import { PaginationOptions } from 'swiper/types/modules/pagination';
import { ParallaxOptions } from 'swiper/types/modules/parallax';
...
import { CSSSelector, SwiperModule } from 'swiper/types/shared';
