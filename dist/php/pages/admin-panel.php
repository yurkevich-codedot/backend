            ...
            <div class="dashboard__logo">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    <stop stop-color="#78aaf5" stop-opacity="0.7" />
          ...
          <div class="dashboard__menu">
            <ul class="dashboard__items">
              ...
              <a href="?table=news" class="dashboard__item">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 12C4 7.58172 7.58172 4 12 4V4C16.4183 4 20 7.58172 20 12V17.0909C20 17.9375 20 18.3608 19.8739 18.6989C19.6712 19.2425 19.2425 19.6712 18.6989 19.8739C18.3608 20 17.9375 20 17.0909 20H12C7.58172 20 4 16.4183 4 12V12Z" stroke="#78aaf5" stroke-width="2"/>
                  <path d="M9 12L15 12" stroke="#78aaf5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M12 9L12 15" stroke="#78aaf5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <li>
                  <p>Новости</p>
                </li>
              ...
              <a href="?table=usersdost" class="dashboard__item">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19.7274 20.4471C19.2716 19.1713 18.2672 18.0439 16.8701 17.2399C15.4729 16.4358 13.7611 16 12 16C10.2389 16 8.52706 16.4358 7.12991 17.2399C5.73276 18.0439 4.72839 19.1713 4.27259 20.4471" stroke="#78aaf5" stroke-width="2" stroke-linecap="round"/>
                  <circle cx="12" cy="8" r="4" stroke="#78aaf5" stroke-width="2" stroke-linecap="round"/>
                </svg>
                <li>
                  <p>Пользователи</p>
                </li>
            ...
            <div class="menu-btn">
              <div class="menu-btn__icon">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M5 7H19" stroke="blue" stroke-linecap="round" />
                  <path d="M5 12H19" stroke="blue" stroke-linecap="round" />
                  <path d="M5 17H19" stroke="blue" stroke-linecap="round" />
                </svg>
              </div>
                      ...
                      <button type="submit" name="id" value="'.$id.'" class="admin-panel__data-kit">
                        ...
                        >
                          <mask
                            ...
                            fill="black"
                          >
                            <rect fill="#78aaf5" x="3" y="4" width="17" height="17" />
                            <path
