            ...
            <?
                   if($_GET['table']=='attraction'){
                    ...
                    while($row = mysqli_fetch_row($data_view)){
                      ...
                      $id = $data_id[0];
                      echo  '<div onclick="window.location.href=\'/dist/attraction.php?id='.$id.'\'" class="admin-panel__item admin-panel__item-link">';
                      foreach($row as $item){
                        if($first == false) {
                          $first = true;
                          continue;
                        ...
                        <button type="submit"  class="admin-panel__data-kit">
                          <svg width="16" height="17" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                              ...
                              fill="black" mask="url(#path-1-outside-1_1154_12363)"/>
                            <path d="M12.5 7.5L15.5 5.5L18.5 8.5L16.5 11.5L12.5 7.5Z" fill="black" />
                          </svg>
                        </button>
                        </form>
                ...
                while($row = mysqli_fetch_row($data)){
                  ...
                  echo '
                  <div class="admin-panel__item-name admin-panel__data-kit-select">
                  <form action="/dist/php/pages/updateInfoPage.php" method="submit">
                  <input type="hidden" name="table" value="'.$_GET['table'].'"/>
